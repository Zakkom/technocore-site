        ...
        <div className="relative z-10">
          ...
          <nav className="fixed top-0 left-0 right-0 z-50 bg-black/90 border-b border-green-500 backdrop-blur">
            <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col sm:flex-row justify-between items-center gap-2">
              {/* Логотип + бренд (кликабельно) */}
              <Link href="/" className="flex items-center gap-3 group focus:outline-none">
                <Image
                  src="/logo.png"            // положи файл в /public/logo.png
                  alt="TechnoCore logo"
                  width={40}
                  height={40}
          ...
          {/* Spacer, чтобы контент не скрывался под fixed-хедером */}
          ...
          <header className="flex flex-col items-center justify-center text-center px-6 py-12">
            <div className="relative w-auto h-40 mb-6">
              <img src="/logo.png" alt="TechnoCore logo large" className="h-full w-auto mx-auto" />
            </div>
          ...
          <section
            id="gallery"
            className="bg-black p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
          >
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  <label htmlFor="interest" className="block text-gray-300 mb-1">
                    Interested in
                  </label>
                  <select
                    id="interest"
              ...
              <button
                type="submit"
                className="mt-6 bg-green-500 hover:bg-green-600 text-black px-6 py-2 rounded"
              >
                Send Message
              </button>
            </form>
