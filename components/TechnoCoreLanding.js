...
export default function TechnoCoreLanding() {
  ...
  // Structured content for detailed view (used by "Learn more")
  const seoMap = {
    nitrogen: {
      ...
      columns: [
        ...
        { subtitle: "Benefits", bullets: ["Reduce dependence on cylinder deliveries","Stable 24/7 supply, predictable OPEX","ROI & sizing calculation included"] }
      ],
    ...
    oxygen: {
      ...
      columns: [
        ...
        { subtitle: "Why on‑site O₂", bullets: ["Eliminate cylinder logistics","Stable flow, low energy use","Safe, scalable configurations"] }
      ],
    ...
    "ref-dryers": {
      ...
      columns: [
        ...
        { subtitle: "Outcome", bullets: ["Reduced corrosion & downtime","Consistent air quality","Lower maintenance"] }
      ],
                ...
                {products.map((product) => (
                  <article key={product.key} className="bg-black border border-green-500 rounded p-6">
                    ...
                    <div className="flex gap-3">
                      ...
                      <a href="#contact" className="border border-sky-500 text-sky-400 hover:bg-sky-500/10 px-4 py-2 rounded">Request Quote</a>
                    </div>
                  </article>
                ))}
              </div>
                ...
                {seoMap[selectedProduct.key] ? (
                  <div className="mt-4">
                    ...
                    <div className="mt-5 flex flex-wrap gap-3">
                      <a href={seoMap[selectedProduct.key].cta.href} className="bg-green-500 hover:bg-green-600 text-black px-5 py-2 rounded">{seoMap[selectedProduct.key].cta.label}</a>
                      <button onClick={handleBack} className="border border-green-500 text-green-400 hover:bg-green-500/10 px-5 py-2 rounded">← Back to products</button>
                    </div>
                  </div>
                ) : (
