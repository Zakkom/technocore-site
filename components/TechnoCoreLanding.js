...
export default function TechnoCoreLanding() {
  const products = [
    ...
    },
    {
      ...
      desc: "RDP/RDHP dryers with capacities up to 13,200 m³/h, PDP +3 °C, using R513a and zero-loss drains.",
    },
    {
      key: "ads-dryers",
      title: "Adsorption (Desiccant) Dryers",
      desc: "R-DRY BVA/BVL/BP models with PDP down to −40 °C. Siemens SIMATIC and energy‑saving DPD modes.",
    },
    {
      key: "filtration",
      title: "Filtration Systems",
      desc: "Coalescing, particulate, activated‑carbon and sterile filters — ISO 8573‑1 compliant.",
    },
    {
      key: "turnkey",
      title: "Chillers & Turnkey Systems",
      desc: "PCI chillers (2–180 kW) and containerised SKID/BOX systems for N₂/O₂ and compressed air.",
    },
  ];
  ...
  // Structured SEO content to render under the product grid
  const seoBlocks = [
    {
      id: "nitrogen",
      title: "Nitrogen Generators (PSA 97–99.9995%)",
      intro:
        "Generate high‑purity nitrogen on‑site and cut long‑term gas costs. TechnoCore sizes and installs PSA N₂ systems across Ireland (SKID/BOX).",
      columns: [
        {
        ...
        },
        {
          ...
          bullets: [
            ...
            "Stable 24/7 supply, predictable OPEX",
            "ROI & sizing calculation included",
          ],
        },
      ],
    ...
    },
    {
      ...
      intro:
        "Independent and efficient on‑site O₂ supply in compact SKID/BOX packages. Easy to install and maintain with local support.",
      columns: [
        {
          subtitle: "Where it fits",
          bullets: ["Aquaculture & fish farms", "Medical & dental", "Welding & cutting"],
        },
        {
          subtitle: "Why choose on‑site O₂",
          bullets: [
            "Eliminate cylinder logistics",
            "Stable flow, low energy use",
            "Safe, scalable configurations",
          ],
        },
      ],
    ...
    },
    {
      ...
      intro:
        "Industrial‑grade RDP/RDHP dryers up to 13,200 m³/h. Protect equipment and product quality for paint, automotive and general manufacturing.",
      columns: [
        {
          subtitle: "Features",
          bullets: ["Energy‑saving controls", "Zero‑loss drains", "High‑flow capability"],
        },
        {
          subtitle: "Outcome",
          bullets: ["Reduced corrosion & downtime", "Consistent air quality", "Lower maintenance"],
        },
      ],
    ...
    {
      id: "ads-dryers",
      title: "Adsorption (Desiccant) Dryers (down to −40 °C PDP)",
      intro:
        "Ultra‑dry compressed air for sensitive processes. Siemens SIMATIC PLC and energy‑saving purge cycles for continuous duty.",
      columns: [
        {
          subtitle: "Use cases",
          bullets: ["Pharma & medical production", "Electronics & semiconductors", "Precision optics"],
        },
        {
          subtitle: "Advantages",
          bullets: ["Quality & compliance", "Lower downtime", "Robust BVA/BVL/BP models"],
        },
      ],
    ...
    },
    {
      ...
      intro:
        "Complete filter trains: coalescing, particulate, activated‑carbon and sterile — sized and supplied by TechnoCore.",
      columns: [
        {
          subtitle: "We provide",
          bullets: [
            "Oil/water removal (coalescing)",
            "Dust protection (particulate)",
            "Oil vapour removal (activated‑carbon)",
          ],
        },
        {
          subtitle: "Results",
          bullets: ["Protect downstream equipment", "Improve product quality", "Meet ISO 8573‑1"],
        },
      ],
    ...
    },
    {
      ...
      title: "Chillers & Turnkey Systems",
      intro:
        "PCI chillers (2–180 kW) and packaged SKID/BOX systems for N₂/O₂ and compressed air — from design to commissioning.",
      columns: [
        {
          subtitle: "Scope",
          bullets: ["Design & planning", "Installation & commissioning", "Maintenance & support"],
        },
        {
          subtitle: "Ideal for",
          bullets: ["Laser systems", "Process cooling", "Integrated plants"],
        },
      ],
    ...
    <main>
      ...
      <div className="relative min-h-screen bg-black text-white font-sans scroll-smooth overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <section id="products" className="bg-gray-900 p-8">
            {!selectedProduct ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {products.map((product) => (
                  <article key={product.key} className="bg-black border border-green-500 rounded p-6">
                    <h3 onClick={() => handleSelect(product)} className="text-xl font-semibold text-green-400 mb-2 cursor-pointer hover:underline">{product.title}</h3>
                    <p className="text-gray-300 mb-4">{product.desc}</p>
                    <div className="flex gap-3">
                      <button onClick={() => handleSelect(product)} className="bg-green-500 hover:bg-green-600 text-black px-4 py-2 rounded">Learn more</button>
                      <a href={`#seo-${product.key}`} className="border border-green-500 px-4 py-2 rounded text-green-400 hover:bg-green-500/10">See details</a>
                    </div>
                  </article>
                ))}
              </div>
              ...
              <div className="bg-black border border-green-500 rounded p-6 max-w-3xl mx-auto">
                ...
                <p className="text-gray-300">Find full details in the section below.</p>
                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                  <a href={`#seo-${selectedProduct.key}`} className="bg-green-500 hover:bg-green-600 text-black px-6 py-2 rounded">Jump to details</a>
          ...
          {/* SEO BLOCKS UNDER THE CARDS */}
          <section id="seo" className="bg-gray-950 p-8">
            <h2 className="text-2xl font-bold text-green-500 mb-6">Detailed Solutions</h2>
            <div className="space-y-10">
              {seoBlocks.map((b) => (
                <article key={b.id} id={`seo-${b.id}`} className="border border-green-500 rounded p-6 bg-black">
                  <h3 className="text-xl font-semibold text-green-400">{b.title}</h3>
                  <p className="text-gray-300 mt-2">{b.intro}</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    {b.columns.map((col, i) => (
                      <div key={i}>
                        <h4 className="text-green-400 font-semibold mb-2">{col.subtitle}</h4>
                        <ul className="list-disc list-inside text-gray-300 space-y-1">
                          {col.bullets.map((it, j) => (
                            <li key={j}>{it}</li>
                          ))}
                        </ul>
                      </div>
                  ...
                  <div className="mt-5 flex flex-wrap gap-3">
                    <a href={b.cta.href} className="bg-green-500 hover:bg-green-600 text-black px-5 py-2 rounded">{b.cta.label}</a>
                    <a href="#contact" className="border border-sky-500 text-sky-400 hover:bg-sky-500/10 px-5 py-2 rounded">Talk to Sales</a>
                  </div>
                </article>
              ))}
            </div>
          ...
          <footer className="bg-black border-t border-green-500 mt-12 py-6 text-center text-gray-400 text-sm">
            <div className="max-w-6xl mx-auto px-4">
              <div className="flex flex-col md:flex-row justify-between items-center mb-4">
                <div className="mb-2 md:mb-0"><span className="text-white font-semibold text-lg">TechnoCore</span> — Industrial Gas Solutions</div>
                <div className="space-x-4">
                  <a href="#products" className="hover:text-green-400">Products</a>
                  <a href="#seo" className="hover:text-green-400">Details</a>
