  ...
  return (
    <main className="min-h-screen bg-black text-white font-sans">
      <Head>
        ...
        <meta name="description" content="Contact TechnoCore to discuss nitrogen and oxygen generators, compressed air dryers, chillers, and industrial gas treatment systems in Ireland." />
      ...
      <div className="p-12 text-center">
        ...
        <p className="text-gray-400 mb-2">Email: <a href="mailto:sales@technocore.ie" className="underline">sales@technocore.ie</a></p>
        <p className="text-gray-400 mb-2">Phone: +353 85 231 44 30</p>
        <p className="text-gray-400 mb-6">Location: Dublin / Wicklow, Ireland</p>

        <form action="https://formsubmit.co/sales@technocore.ie" method="POST" className="mt-4 max-w-xl mx-auto text-left">
